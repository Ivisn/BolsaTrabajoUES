	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<h2>Nuestro Plataforma</h2>
			</div>
			<div class="col-md-3 col-sm-3">
				<i class="fa icon-apretonmanos"></i>
				<h3>Encuentra</h3>
				<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet. Dolore magna aliquam erat volutpat.</p>
			</div>
			<div class="col-md-3 col-sm-3">
				<i class="fa icon-empresa"></i>
				<h3>Empresa</h3>
			...
			<div class="col-md-3 col-sm-3">
				<i class="fa icon-muchos"></i>
				<h3>Aspirante</h3>
				<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet. Dolore magna aliquam erat volutpat.</p>
			</div>
			<div class="col-md-3 col-sm-3">
				<i class="fa icon-file-text2"></i>
				<h3>Documentos</h3>
				<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet. Dolore magna aliquam erat volutpat.</p>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 col-sm-6">
				<img src="<?=base_url()?>public/images/findCV2.png" class="img-responsive" alt="about img">
			</div>
			<div class="col-md-6 col-sm-6">
				<h3>SELECCIONE SU ASPIRANTE</h3>
...
<div id="portfolio">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 col-sm-6">
				<img src="<?=base_url()?>public/images/insertCV.png" class="img-responsive" alt="about img">
			</div>
			<div class="col-md-6 col-sm-6">
				<h3>ABOUT US</h3>
				<h4>Talented Designers &amp; Developers</h4>
